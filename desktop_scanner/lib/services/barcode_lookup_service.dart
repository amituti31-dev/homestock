...
/// letting the user type the name. Open Food Facts asks clients to identify
/// themselves via User-Agent.
class BarcodeLookupService {
  static const _userAgent =
      'HomeStock-DesktopScanner/1.0 (https://github.com/homestock)';
